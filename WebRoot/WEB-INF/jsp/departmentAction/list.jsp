...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData" class="dataContainer" datakey="departmentList">
        	<s:iterator value="#departmentList">        <!-- 显示的List集合 -->
				<tr class="TableDetail1 template">
				    <td><s:a action="department_list?parentId=%{id}">${name}</s:a>&nbsp;</td>
					<td>${parent.name}&nbsp;</td>       <!-- El表达式也是对象图导航语言(级联查询) -->
					<td>${description}&nbsp;</td>
					<td> 
					    <s:a action="department_delete?id=%{id}&parentId=%{parentId}" onClick="return confirm('这将删除所有的下级部门，您确定要删除吗？')" >删除</s:a>
